...
<div class="container py-2" style="max-width: 440px; margin: 0 auto;">
    ...
    <div id="list-view-section">
        ...
        <div id="no-results-msg" class="p-4 text-center text-muted card border-0 rounded-4 shadow-sm"
            style="display: none;">
    ...
    function openRequestModal(item) {
        ...
        if (pickupBtn && pickupBtnText) {
            if (item.status === 'PICKED_UP') {
                ...
                pickupBtn.href = '#';
                pickupBtn.className =
                    'btn btn-secondary w-50 d-flex align-items-center justify-content-center py-2 disabled';
