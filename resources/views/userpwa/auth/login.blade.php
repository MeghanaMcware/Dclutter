        ...
        <div class="login-card">
            ...
            <div id="phoneSection">
                ...
                <form id="phoneForm" class="needs-validation" novalidate onsubmit="showOtp(event)">
                    <div class="position-relative mb-3">
                        <input type="tel" class="form-control form-control-lg" placeholder="Enter Mobile Number"
            ...
            <div id="otpSection">
                ...
                <form action="{{ route('user.dashboard') }}" method="GET" class="needs-validation" novalidate>
                    <div class="position-relative mb-3">
                        <input type="text" class="form-control form-control-lg" placeholder="----" pattern="^[0-9]{4}$"
                    ...
                    <p class="mt-3 text-muted" style="font-size: 13px; cursor: pointer;" onclick="showPhone()">Change
                        Mobile Number</p>
                </form>
            </div>
        </div>
